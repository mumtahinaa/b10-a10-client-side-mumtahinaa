  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-[#000000] p-6">
      <div className="w-full max-w-lg p-8 bg-opacity-90 bg-[#1E1E1E] rounded-lg shadow-xl backdrop-blur-md">
        <h2 className="text-4xl font-bold text-center text-[#9B5DE5] mb-2">Update Movie</h2>
        <p className="text-center text-gray-400 mb-6">🎥 Modify movie details below.</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              {...register("poster", { required: "Movie poster URL is required" })}
            />
